...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { purchase_price: @price.purchase_price, retail_price: @price.retail_price, title: @price.title, vendor_id: @price.vendor_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { purchase_price: @price.purchase_price, retail_price: @price.retail_price, title: @price.title, vendor_id: @price.vendor_id } }
