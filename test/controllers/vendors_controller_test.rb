...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference("Vendor.count") do
      post vendors_url, params: { vendor: { manager: @vendor.manager, title: @vendor.title } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { manager: @vendor.manager, title: @vendor.title } }
